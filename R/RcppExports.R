...
mult_abund_mcmc <- function(data_list, pred_list, initial_list, prior_list, block, begin_group_update, burn, iter) {
    .Call('multAbund_mult_abund_mcmc', PACKAGE = 'multAbund', data_list, pred_list, initial_list, prior_list, block, begin_group_update, burn, iter)
}

mult_occ_mcmc <- function(data_list, pred_list, initial_list, prior_list, block, begin_group_update, burn, iter) {
...
probit_reg_mcmc <- function(data_list, pred_list, prior_list, initial_list, burn, iter) {
