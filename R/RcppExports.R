...
mult_pois_mcmc <- function(data_list, pred_list, initial_list, prior_list, block, begin_group_update, burn, iter) {
    .Call('multAbund_mult_pois_mcmc', PACKAGE = 'multAbund', data_list, pred_list, initial_list, prior_list, block, begin_group_update, burn, iter)
}
