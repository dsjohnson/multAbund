...
delta_pi = sweep(delta_pi, 2, colMeans(delta_pi))
delta_pi = as.vector(t(delta_pi))
beta = c(2,0.5)
...
prox = melt(apply(fit$prox, c(1,2), mean))
p1 = ggplot(aes(x=Var1, y=Var2), data=prox) + geom_tile(aes(fill=value)) + labs(x=NULL, y=NULL) +
