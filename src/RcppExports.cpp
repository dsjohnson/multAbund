...
RcppExport SEXP _multAbund_mult_zip_mcmc(SEXP data_listSEXP, SEXP initial_listSEXP, SEXP prior_listSEXP, SEXP blockSEXP, SEXP begin_group_updateSEXP, SEXP burnSEXP, SEXP iterSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::List& >::type data_list(data_listSEXP);
    ...
    Rcpp::traits::input_parameter< const int& >::type burn(burnSEXP);
    Rcpp::traits::input_parameter< const int& >::type iter(iterSEXP);
    rcpp_result_gen = Rcpp::wrap(mult_zip_mcmc(data_list, initial_list, prior_list, block, begin_group_update, burn, iter));
    return rcpp_result_gen;
END_RCPP
}
// pois_reg_mcmc
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_multAbund_mult_zip_mcmc", (DL_FUNC) &_multAbund_mult_zip_mcmc, 7},
